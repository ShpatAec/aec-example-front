...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-white sticky top-0 p-2 flex justify-evenly uppercase shadow-xl title-primary w-full grid grid-cols-2">
        ...
        {currentUser ? (
          <FormControl sx={{ m: 1, minWidth: 120 }}>
            <Select
              ...
              className="text-black hover:text-red-500 font-medium mr-4 transition duration-500 ease-in-out"
              MenuProps={{
                sx: {
                  "&& .Mui-selected": {
            ...
            >
              ...
              <MenuItem value="accountSettings">
                <Link
                  to={"/accountSettings"}
                  className="title-primary uppercase rounded-lg px-3 py-2 text-black hover:text-red-500 font-medium mr-4 transition duration-500 ease-in-out"
                >
        ...
        >
          {navbar ? (
            <svg
              ...
              className="w-6 h-6 hover:text-red-500 transition duration-500 ease-in-out"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
